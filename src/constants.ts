...
export const CONTROL_MSG_TYPE = {
  ...
  ROTATE_DEVICE: 11,
  // Custom extension (not in upstream scrcpy): mouse hover / cursor position.
  // Used by the iOS backend to drive UIPointerInteraction; ignored by Android.
  INJECT_MOUSE_HOVER_EVENT: 21,
} as const;
